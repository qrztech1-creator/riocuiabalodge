    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8 border-b pb-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Gerencie as postagens ao vivo da pescaria. As fotos e vídeos adaptam-se ao tamanho original e stories temporários expiram automaticamente.</p>
        </div>
        <Link
